...
python generate/base_filter_culture.py --checkpoint_dir /scr/biggest/weiyans/CultureBank/model/checkpoints/meta-llama/Llama-2-70b-hf/ --precision bf16-true --quantize bnb.nf4-dq --comment_dir ~/CultureBank/tiktok/comments_culturaldifference_50.json --video_dir ~/CultureBank/tiktok/videos_culturaldifference_50.json --results_dir ~/CultureBank/tiktok/results_70b.json --temperature 0.1 --top_k 1
"""
import sys
import time
