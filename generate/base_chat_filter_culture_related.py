...
python generate/base_chat_filter_culture_related.py --checkpoint_dir ~/CultureBank/lit-gpt_ours/checkpoints/meta-llama/Llama-2-70b-chat-hf/ --precision bf16-true --quantize bnb.nf4-dq --comment_dir /juice/scr/weiyans/CultureBank/tiktok_data/subset/predicted_cultural_relateness.json --results_dir ~/CultureBank/tiktok/results_70b_chat_500_culture_related.json --temperature 0.01 --top_k 1
...
from prompt_utils import annotate_chat_prompt_culture_related
...
def main(
    *,
    ...
    prompts = [
        ...
        annotate_chat_prompt_culture_related(comment[0])
