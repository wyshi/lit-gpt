"""
python generate/base_chat_filter_culture.py --checkpoint_dir /scr/biggest/weiyans/CultureBank/model/checkpoints/meta-llama/Llama-2-70b-chat-hf/ --precision bf16-true --quantize bnb.nf4-dq --comment_dir ~/CultureBank/tiktok/comments_culturaldifference_50.json --results_dir ~/CultureBank/tiktok/results_70b_chat.json --temperature 0.1
...
from lit_gpt.utils import check_valid_checkpoint_dir, get_default_supported_precision, lazy_load, gptq_quantization, load_checkpoint
